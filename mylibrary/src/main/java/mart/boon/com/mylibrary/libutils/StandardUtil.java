...
import mart.boon.com.mylibrary.base.BaseAppCompatActivity;
...
public class StandardUtil {
    ...
    public static void addFragment(Context context, int viewResourceId, android.support.v4.app.Fragment fragment, boolean withAnimation) {
        android.support.v4.app.FragmentTransaction fragmentTransaction = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
        if (withAnimation) {
            fragmentTransaction.setCustomAnimations(R.anim.right_in, R.anim.left_out,
                    R.anim.left_in, R.anim.right_out);
        ...
        fragmentTransaction.addToBackStack(fragment.getClass().getSimpleName());
        fragmentTransaction.add(viewResourceId, fragment, fragment.getClass().getSimpleName()).commit();
    }

    public static void addFragmentWithOutBackStack(Context context, int viewResourceId, android.support.v4.app.Fragment fragment, boolean withAnimation) {
        android.support.v4.app.FragmentTransaction fragmentTransaction = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
        if (withAnimation) {
            fragmentTransaction.setCustomAnimations(R.anim.right_in, R.anim.left_out,
                    R.anim.left_in, R.anim.right_out);
    ...
    public static void removeFragmentForBackStack(android.support.v4.app.FragmentManager fm, List<String> stringList) {
        android.support.v4.app.FragmentTransaction ft = fm.beginTransaction();
        for (int i = 0; i < stringList.size(); i++) {
           // ft.remove(stringList.get(i));
            ft.commit();
            fm.popBackStack();
        }
    ...
    public static void startActivityAllStackClear(Context context, Class<?> className) {
        Intent intent = new Intent(context, className);
    ...
    public static void startActivity(Context context, Class<?> className, int flags,Bundle args) {
        Intent intent = new Intent(context, className);
        intent.putExtras(args);
        intent.setFlags(flags);
        context.startActivity(intent);
    ...
    public static void setFragmentadd (Context context, int viewResourceId, android.support.v4.app.Fragment fragment, boolean withAnimation) {
        android.support.v4.app.FragmentTransaction fragmentTransaction = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
        if (withAnimation) {
            fragmentTransaction.setCustomAnimations(R.anim.right_in, R.anim.left_out,
                    R.anim.left_in, R.anim.right_out);
    ...
    public static void setFragmentaddnew(Context context, int viewResourceId, android.support.v4.app.Fragment fragment, boolean withAnimation) {
        android.support.v4.app.FragmentTransaction fragmentTransaction = ((AppCompatActivity) context).getSupportFragmentManager().beginTransaction();
        if (withAnimation) {
            fragmentTransaction.setCustomAnimations(R.anim.right_in, R.anim.left_out,
                    R.anim.left_in, R.anim.right_out);
